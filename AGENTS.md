...
This project is indexed by GitNexus as **smartlock-next** (4066 symbols, 5291 relationships, 96 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
