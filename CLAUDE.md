...
This project is indexed by GitNexus as **smartlock-next** (4579 symbols, 5445 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
