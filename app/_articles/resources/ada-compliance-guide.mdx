...
description: >-
  Is your keypad legal? We explain the 'Startlingly Simple' test for ADA
  compliance in smart locks, mounting heights, and why round knobs are illegal
  in rentals.
category: resources
...
keywords:
  - ada compliance smart lock
  - rule 404.2.3
  - door hardware requirements
  - lever vs knob legal
  - smart lock mounting height
  - rental property lock laws
tags:
  - glossary
  - standard
...
## Related Tools
*   **[Installation Cost Estimator](/calculators/installation-cost)**: Factor in new lever handles.
