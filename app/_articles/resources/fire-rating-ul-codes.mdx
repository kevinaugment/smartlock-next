...
description: >-
  Fire inspectors are failing smart lock installs correctly. Learn about UL 10C,
  20-minute ratings, and why you cannot modify a fire door for a smart lock.
category: resources
...
*   **[Installation Cost Estimator](/calculators/installation-cost)**: Warning: Fire door installs cost more due to liability.
