...
description: >-
  Identifies the top 5 unexpected costs that blow up smart lock budgets. From
  door alignment issues to Wi-Fi bridge redundancy, learn what salesmen won't
  tell you.
category: resources
...
## Related Tools
*   **[Installation Cost Estimator](/calculators/installation-cost)**: Include a contingency slider in your estimate.
*   **[Door Compatibility Guide](/articles/guides/door-compatibility-guide)**: Measure twice, buy once.
