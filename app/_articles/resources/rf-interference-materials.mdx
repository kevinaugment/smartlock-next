...
description: >-
  Why does your lock fail when the bathroom door closes? A physics-based guide
  to material attenuation (dB Loss) for 2.4GHz vs 900MHz signals. Stucco,
  Mirrors, and Metal explained.
category: resources
