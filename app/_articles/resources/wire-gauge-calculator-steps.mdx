...
description: >-
  Why does your magnetic lock fail? It's probably Voltage Drop. We explain how
  to calculate AWG wire thickness for 12V and 24V cable runs.
category: resources
...
*   **[Installation Guide](/articles/installation/install-smart-lock-step-by-step)**: Step-by-step hardware setup.
